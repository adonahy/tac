...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Asociación</b>Academia</span>
    </a>
...
?>
      <form id="login" class="login-form" action="dashboard.php" method="post">
        <input type="text" placeholder="User" name="user" class="pass" id="user"/><span class="arrow">&rarr;</span>
        <input type="password" placeholder="Password" name="pass" class="pass" id="pass"/><span class="arrow">&rarr;</span>
